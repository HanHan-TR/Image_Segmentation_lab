...
from core.fileio.path import is_filepath
from core.fileio import HardDiskBackend
try:
    from turbojpeg import TJCS_RGB, TJPF_BGR, TJPF_GRAY, TurboJPEG  # pip install pyturbojpeg
except ImportError:
...
def imread(img_or_path,
    ...
    if isinstance(img_or_path, np.ndarray):
        ...
        img_bytes = file_client.get(filepath=img_or_path)
